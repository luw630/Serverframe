...
DWORD CChaseThiefDataManager::m_dwChaseThiefDurationTime = 0;
DWORD CChaseThiefDataManager::m_dwChaseThiefOpenLevel = 0;
float CChaseThiefDataManager::m_fChaseThiefActivateRate = 0;
