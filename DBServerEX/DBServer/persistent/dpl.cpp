...
#include "time.h"
#include "../zoneserver/GameObjects/CPlayerDefine.h"
#include "../zoneserver/GameObjects/CPlayerService.h"
	...
	void _p::SavePlayerData( DNID dnidClient, SQSaveCharacterMsg * pMsg)
	{
        ...
        else
        {
		    ...
		    try
		    {
			    ...
			    dpLayer.SaveIntoCache( pMsg->dwServerId, (SFixData&)pMsg->PlayerData, account );
		    }
		    catch( lite::Xcpt &e )
		    {
